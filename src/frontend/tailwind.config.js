  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "glow-md": "0 0 16px rgba(0, 255, 136, 0.4)",
        "glow-lg": "0 0 24px rgba(183, 0, 255, 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 16px rgba(0, 255, 136, 0.4)" },
          "50%": { boxShadow: "0 0 24px rgba(183, 0, 255, 0.5)" },
        },
        "rotate-gradient": {
